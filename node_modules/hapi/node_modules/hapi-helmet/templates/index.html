	...
	<body>
		<script>
			...
			$(document).ready(function() {
				...
				$(document).on('click', 'dt p .sign', function(e) {
				...
				$(document).on('click', '.urlEllipses', function() {

					$(this).hide();
					$(this).siblings('.urlSecondHalf').show();
				});
				$(document).on('click', '.urlSecondHalf', function() {
		...
		<div id="textPage">
			<h1 id="Helmet">Helmet : Interactive Debug Console</h1>
		    <div id="sessionWrapper"> 
		        <input id="session" value="*" />
		        <button id="subscribe" onclick="wsSend();">Subscribe</button>
		    </div>
		    <hr id="sessionWrapperRuler">
	    	<div class="row" id="columnNames">
	    		<div class="span3">
	    			<h2 class="columnName">Method | URL</h2>
	    		</div>
	    		<!--<div class="span2">
	    			<<h2 class="columnName">Time</h2>
	    		</div>-->
	    		<div class="span2">
	    			<h2 class="columnName">Tags<h2>
	    		</div>
	    		<div class="span5">
	    			<h2 class="columnName">Data</h2>
	    		</div>
	    	</div>
